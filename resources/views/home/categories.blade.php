...
<head>
    ...
    <!-- Start Index 1 -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('template/assets/fi/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('template/assets/fi/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('template/assets/fi/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('template/assets/fi/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ asset('template/assets/fi/safari-pinned-tab.svg') }}" color="#5bbad5">
...
<body class="features-sections">
                    ...
                    <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-5">
                        ...
                        <div class="dropdown-menu ms-n3 dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3"
                            ...
                            <div class="d-none d-lg-block">
                                ...
                                <a href="{{ asset('template/pages/about-us.html') }}"
                                    class="dropdown-item border-radius-md">
                                    <span>About Us</span>
                                </a>
                                <a href="{{ asset('template/pages/contact-us.html') }}"
                                    class="dropdown-item border-radius-md">
                                    <span>Contact Us</span>
                                </a>
                                <a href="{{ asset('template/pages/author.html') }}"
                                    class="dropdown-item border-radius-md">
                                    <span>Author</span>
                                </a>
                                <h6
                                ...
                                <a href="{{ asset('template/pages/sign-in.html') }}"
                                    class="dropdown-item border-radius-md">
                                    <span>Sign In</span>
                                </a>
                            </div>
                            ...
                            <div class="d-none d-lg-block">
                                <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="{{ asset('template/presentation.html') }}">
                                        <div class="w-100 d-flex align-items-center justify-content-between">
                                            ...
                                            <img src="{{ asset('template/assets/img/down-arrow.svg') }}"
                                                alt="down-arrow" class="arrow">
                                        </div>
                                    </a>
                                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/page-sections/hero-sections.html') }}">
                                            Page Headers
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/page-sections/features.html') }}">
                                            Features
                                        </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                                    ...
                                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/navigation/navbars.html') }}">
                                            Navbars
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/navigation/nav-tabs.html') }}">
                                            Nav Tabs
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/navigation/pagination.html') }}">
                                            Pagination
                                        </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                                    ...
                                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/input-areas/inputs.html') }}">
                                            Inputs
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/input-areas/forms.html') }}">
                                            Forms
                                        </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                                    ...
                                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/attention-catchers/alerts.html') }}">
                                            Alerts
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/attention-catchers/modals.html') }}">
                                            Modals
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/attention-catchers/tooltips-popovers.html') }}">
                                            Tooltips & Popovers
                                        </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                                    ...
                                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/avatars.html') }}">
                                            Avatars
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/badges.html') }}">
                                            Badges
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/breadcrumbs.html') }}">
                                            Breadcrumbs
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/buttons.html') }}">
                                            Buttons
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/dropdowns.html') }}">
                                            Dropdowns
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/progress-bars.html') }}">
                                            Progress Bars
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/toggles.html') }}">
                                            Toggles
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                            href="{{ asset('template/sections/elements/typography.html') }}">
                                            Typography
                                        </a>
                                    </div>
                                </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-animation dropdown-md dropdown-md-responsive mt-0 mt-lg-3 p-3 border-radius-lg"
                            ...
                            <div class="row d-lg-none">
                                <div class="col-md-12 g-0">
                                    <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        href="{{ asset('template/pages/about-us.html') }}">
                                        <h6
                                            class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">
                                            Getting Started</h6>
                                        <span class="text-sm">All about overview, quick start, license and
    ...
    <div class="container mt-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="https://demos.creative-tim.com/material-kit-pro/index">Page
                                    Sections</a></li>
                    ...
                    <div class="container border-bottom">
                        <div class="row justify-space-between py-2">
                            <div class="col-lg-3 me-auto">
                                <p class="lead text-dark pt-1 mb-0">Home 1</p>
                            </div>
                            <div class="col-lg-3">
                                    ...
                                    <ul class="nav nav-pills nav-fill flex-row p-1" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab"
                                                href="#preview-features-1" role="tab" aria-selected="true">
        ...
        <link rel="stylesheet" type="text/css"
                            ...
                            <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
                            <link id="pagestyle"
                                href="https://demos.creative-tim.com/material-kit/assets/css/material-kit.min.css?v=3.0.0"
                                rel="stylesheet" />
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6 my-auto">
                                            ...
                                            <p class="pe-5">Pain is what we go through as we become older. We
                                                get insulted by others, lose trust for those others. We get back stabbed
                                        ...
                                        <div class="col-lg-6 mt-lg-0 mt-5 ps-lg-0 ps-0">
                                            ...
                                            <div class="p-3 info-horizontal">
                                                ...
                                                <div class="description ps-3">
                                                    <p class="mb-0">As we live, our hearts turn colder.
                                                        <br>Cause pain is what we go through as we become older.</p>
                                                </div>
                                            </div>
                                            <div class="p-3 info-horizontal">
                                                <div
                        ...
                        <div class="tab-pane" id="code-features-1">
                            <div class="position-relative p-4 pb-2">
                                <a class="btn btn-sm bg-gradient-dark position-absolute end-4 mt-3"
                                    onclick="copyCode(this);" href="javascript:;"><i
        ...
        <div class="container">
            <div class=" row">
                <div class="col-md-3 mb-4 ms-auto">
                    <div>
                        <a href="">
                            <img src="{{ asset('template/assets/fi/favicon.ico') }}" class="rounded-circle m-0 p-0">
                            
                                          <!-- <img src="./assets/img/logo-ct-dark.png') }}"
                                class="mb-3 footer-logo" alt="main_logo"> -->
                        </a>
                        <h6 class="font-weight-bolder mb-4">P L U G &nbsp; L I M I T E D</h6>
                    </div>
                    <div>
                        <ul class="d-flex flex-row ms-n3 nav">
                            <li class="nav-item">
                                <a class="nav-link pe-1" href="https://facebook.com/pluglimited.org" target="_blank">
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="text-dark my-4 text-sm font-weight-normal">
                            <script>
                                document.write(new Date().getFullYear())
                            </script> <a href="https://pluglimited.org"
                                target="_blank">Pluglimited</a>.
                        </p>
                    </div>
                </div>
            </div>
