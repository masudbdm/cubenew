    ...
    <section class="content">
        <div class="card card-widget">
            ...
            <div class="card-body" style="background-color: #ccc;">
                <div class="row">
                    <div class="col-md-7">
                        <form method="post" action="{{ route('admin.storeVideoGallery',$videoGallery) }}">
                          @csrf
                            <div class="card card-widget">
                                <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <input type="text" name="title" class="form-control {{ $errors->has('title') ? ' form-error' : '' }}" value="{{ old('title') }}" id="title"
                                    ...
                                    <div class="form-group">
                                        <label for="videoUrl" class="control-label">Youtube Video Url</label>
                                            <input type="text" name="videoUrl" class="form-control {{ $errors->has('videoUrl') ? ' form-error' : '' }}"
                                                value="{{ old('videoUrl') }}" id="videoUrl"
