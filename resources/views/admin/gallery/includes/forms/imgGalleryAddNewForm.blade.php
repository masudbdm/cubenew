                    ...
                    <div class="card card-widget">
                        <div class="card-body">
                            ...
                            <div class="form-group row {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <label for="title" class="col-sm-4 control-label">Gallery Title</label>
                                <div class="col-sm-8">
                                    <input type="text" name="title" class="form-control" value="{{ old('title') }}"
                                        id="title" placeholder="Title of Image Gallery" autocomplete="off">
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group  {{ $errors->has('description') ? ' has-error' : '' }}">
                                <div class="row">
                                    <label for="description" class="col-sm-4 control-label">Gallery Description</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group row {{ $errors->has('link_url') ? ' has-error' : '' }}">
                                <label for="link_url" class="col-sm-4 control-label">Link Url </label>
                                <div class="col-sm-8">
                                    <input type="text" name="link_url" class="form-control"
                                        value="{{ old('link_url') }}" id="link_url"
                            ...
                            <div class="card-body">
                                <form class="form-horizontal gallery-item-form" method="post"
                                    ...
                                    <div class="form-group row {{ $errors->has('img_url') ? ' has-error' : '' }}">
                                        <label for="img_url" class="col-sm-4 control-label">Item Image Url</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row {{ $errors->has('title') ? ' has-error' : '' }}">
                                        <label for="title" class="col-sm-4 control-label">Item Title</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row {{ $errors->has('photo_credit') ? ' has-error' : '' }}">
                                        <label for="photo_credit" class="col-sm-4 control-label">Photo Credit</label>
                                        <div class="col-sm-8">
